...
self.addEventListener(repository, function (e) {
  ...
  self.postMessage(`pulling data for repository:`, repository.name);
  ...
  if (pullRequests.length) {
    ...
    self.postMessage(pullCount, `pulls tally`);
  }
  ...
  for (const pullRequest of pullRequests) {
    ...
    if (reviews.length) {
      ...
      self.postMessage(reviewCount, `reviews tally`);
    }
    ...
    if (comments.length) {
      ...
      self.postMessage(commentCount, `comments tally`);
    }
